...
public class BookController {
    ...
    public String getBooksPage(@RequestParam(required = false) String error,
                               ...
                               @RequestParam(required = false) String search, @RequestParam(defaultValue = "1") Integer pageNum,
        ...
        if (authorId != null) {
            ...
            books = (search != null && !search.isEmpty()) ? bookService.searchBooks(search) : bookService.listAll();
        }
        ...
        model.addAttribute("bodyContent", "booksList");
